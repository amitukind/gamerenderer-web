...
export const work = {
  ...
  items: [
    { title: 'WebGL Racer', category: 'Browser · Three.js', image: 'the-beetle', accent: '#9a5fce' },
    { title: 'Hyper-Casual Pack', category: 'Mobile · Unity', image: 'fuji', accent: '#6b8fce' },
    { title: 'AR Product Viewer', category: 'AR · Vuforia', image: 'lamp', accent: '#ce5f9a' },
    { title: 'Multiplayer Arena', category: 'Realtime · Photon', image: 'woodcraft', accent: '#5fcea8' },
    { title: 'Character Studio', category: 'Art · 3D / Animation', image: 'lady-shutterbug', accent: '#cea85f' },
    { title: 'Casual Puzzle Series', category: 'Web & Mobile', image: 'salad', accent: '#9a5fce' },
  ],
}
